...
ActiveRecord::Schema[7.1].define(version: 2024_10_05_054200) do
  ...
  create_table "insurance_documents", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["property_id"], name: "index_insurance_documents_on_property_id"
  end
  ...
  add_foreign_key "insurance_documents", "properties"
